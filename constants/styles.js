 ...
 * Includes primary and grayscale variations.
 */
...
export const COLORS = {
  ...
  /**
   * Additional UI colors used for status indicators and semantic coloring.
   */
  ...
  /**
   * Hebrew car color name mapping to corresponding hex values.
   * Used for visualizing car colors in a consistent way.
   */
...
/**
 * Returns the uppercase initials from first and last name.
 *
 * @param {string} fname - First name
 * @param {string} lname - Last name
 * @returns {string} Initials in uppercase (e.g. "AB")
 */
...
/**
 * Reverses the given Hebrew text to fix RTL display issues.
 *
